<template>
  ...
  <div class="body" ref="scrollRef"> 
    <div v-if="!conversationList.length" class="explain">
      <img class="logo" alt="Vue logo" v-if="rolecontent" :src="rolecontent.softIcon" />
      <img class="logo" alt="Vue logo" v-else src="../assets/logo02.svg" />
...
export default {
  ...
  setup() {
	  ...
	  (newValue) => {
		if(newValue.path=='/chatai'){
		   ...
		   if(conversationList.value.length==0){
			  ...
			  console.log("conversationList.value.length"+itemRoleJ.softContent);
		   }
		}
	  }
	);
	...
	let itemRole = {
		icon: "",
		softName: "神码智能AI能助手",
		softPromot: "我是神码智能AI能助手，有什么可以帮助你呢",
	};
