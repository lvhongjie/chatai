<template>
 <div class="body">
   ...
   <div class="container" v-else>
     ...
     <div class="tab-box" >
       <div
           style="display: flex ;background-color: #7d80ff;height: 140px;margin-bottom: 40px;align-items: center;border-radius: 3px;box-shadow: 0 2px 6px #ffffff">
       ...
       <el-table :data="dataTables"  height="350px" :header-cell-style="{ background:' #ffffff'}" style="background-color: #ffffff"
                 :row-style="{ height: '100%', background:' #ffffff' }">
