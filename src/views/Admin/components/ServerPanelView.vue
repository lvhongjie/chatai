  ...
  <div class="s_container">
    <el-scrollbar height="100%">
      <el-form :inline="true" class="demo-form-inline" label-position="left">
		...
		<el-form-item label="FastGPT对话请求链" label-width="200px">
		    <el-input
		      placeholder="请设置FastGPT请求链"
		      clearable
		      v-model="form.fastAiUrl"
		    />
		</el-form-item>
		...
		<el-form-item label="FastGPT对话密钥" label-width="200px">
		  <el-input
		    placeholder="请设置密钥"
		    clearable
		    v-model="form.fastKey"
		  />
		</el-form-item>
