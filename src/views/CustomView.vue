<template>
  <div
    ...
    <div
      ...
      class="explain">
      <div class="logo" v-if="checkIfContains(data.icon)">
		<img :src="getImageUrl(data.icon)" class="image">
      </div>
  ...
  export default {
    ...
    setup() {
      ...
      function checkIfContains (str) {
      	 try {
      			return str.endsWith( '.png')||str.endsWith( '.svg');
      	       } catch (error) {
      	        return false;
      	   }
